...
class GoogleSheetsManager:
    ...
    def _get_column_mappings(self) -> Dict[str, str]:
        ...
        return {
            """본 "설문"을 위한 개인정보 수집·이용 동의""": """본 "설문"을 위한 개인정보 수집·이용 동의""",
            "분양계약서 업로드(계약서 일부 발췌)": "분양계약서 업로드(계약서 일부 발췌)",
            "이름": "이름",
            "자격구분": "자격구분",
            "세대 대표자 여부": "세대 대표자 여부",
            "비상연락망": "비상연락망",
            "네이버카페 ID": "네이버카페 ID",
            "위임장":"위임장",
            """"입주예정자협의회 업무 추진"을 위한 개인정보 수집, 이용, 제공 동의""": """"입주예정자협의회 업무 추진"을 위한 개인정보 수집, 이용, 제공 동의""",
            "청탁 및 금품수수 금지 서약": "청탁 및 금품수수 금지 서약"
        }
